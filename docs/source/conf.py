...
exclude_patterns = ['build', 'api/PrintTags.print_tags.rst']
...
htmlhelp_basename = 'PrintTagsdoc'
...
latex_documents = [
    (master_doc, 'PrintTags.tex', 'PrintTags Documentation',
     'Michael Lockyer', 'manual'),
]
